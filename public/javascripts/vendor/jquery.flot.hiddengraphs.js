...
(function ($) {
    ...
    function init(plot) {
        ...
        function legendRowForLabel(label){
          return $(plot.getCanvas()).parent().find('.legend tr .legendLabel .graphlabel:contains("'+label+'")').parents('tr');
        }
        ...
        function plotLabelClicked(label, mouseOut) {
            ...
            if (series.lines.show) {
                ...
                legendRowForLabel(label).addClass('disabled');
            } else {
                //series.points.show = true;
                series.lines.show = true;
                //series.label = series.label.replace(labelHidden, '');
                legendRowForLabel(label).removeClass('disabled');
            }
            console.log(legendRowForLabel(label));
            //console.log(legendRowForLabel(label));
            //console.log($(legendRowForLabel(label)));
            plot.setupGrid();
            plot.draw();
        ...
        function plotLabelHandlers(plot, options) {
            ...
            $(".graphlabel").click(function() { plotLabelClicked($(this).parent().text()); });
            if (!drawnOnce) {
                drawnOnce = true;
